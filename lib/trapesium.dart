...
class _PenjumlahanState extends State<trapesium> {
            ...
            children: <Widget>[
              Container(
                  ...
                  child: TextField(
                    controller: txtsa,
                    autocorrect: true,
                    decoration: InputDecoration(hintText: 'panjang sisi bawah trapesium'),
                  )),
              ...
              Container(
                  ...
                  child: TextField(
                    controller: txtsb,
                    autocorrect: true,
                    decoration: InputDecoration(hintText: 'panjang sisi atas Trapesium'),
                  )),
              ...
              Container(
                  ...
                  child: TextField(
                    ...
                    autocorrect: true,
                    decoration: InputDecoration(hintText: 'panjang tinggi trapesium'),
                  )),

              RaisedButton(
                onPressed: getTextInputData,
                color: Color(0xff85c933),
              ...
              Padding(
                  ...
                  child: Text("Luas Trapesium = $result", style: TextStyle(fontSize: 20)))
            ],
          ),
        ));
  }
