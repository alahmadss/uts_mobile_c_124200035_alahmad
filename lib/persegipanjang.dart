            ...
            children: <Widget>[
              Container(
                  ...
                  child: TextField(
                    ...
                    autocorrect: true,
                    decoration: InputDecoration(hintText: 'panjang tinggi segitiga'),
                  )),
              ...
              Container(
                  ...
                  child: TextField(
                    controller: txtlebar,
                    autocorrect: true,
                    decoration: InputDecoration(hintText: 'panjang lebar Persegi Panjang'),
                  )),
              ...
              Padding(
                  ...
                  child: Text("Luas Persegi Panjang = $result", style: TextStyle(fontSize: 20)))
            ],
          ),
        ));
  }
